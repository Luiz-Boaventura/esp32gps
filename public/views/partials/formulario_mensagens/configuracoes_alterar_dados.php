<?php 
if(isset($_SESSION['configuracoes_alterar_dados_mensagem']) && isset($_SESSION['configuracoes_alterar_dados_mensagem'])) {
    //MENSAGEM ERRO
    ...
    unset(
        $_SESSION['configuracoes_alterar_dados_mensagem'],
        $_SESSION['mensagem']
    );
}